...
public class RenameMethodDialog extends ThemedJDialog {

    private final JTextField nameField;
    private boolean confirmed = false;

    public RenameMethodDialog(Window owner, String currentMethodName, String methodDesc) {
        super(owner, "Rename Method", ModalityType.APPLICATION_MODAL);
        ...
        JLabel currentLabel = new JLabel("Current: " + currentMethodName + methodDesc);
        ...
        gbc.weightx = 1.0;
        nameField = new JTextField(currentMethodName, 25);
    ...
    private boolean validateInput() {
        ...
        if (name.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Method name cannot be empty",
                    "Validation Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if (!isValidJavaIdentifier(name)) {
            JOptionPane.showMessageDialog(this, "Invalid method name: " + name,
                    "Validation Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
