...
public final class LiveProtocol {
    ...
    public static final int MSG_SCAN_FIRST = 0x30;  // req: u8 valueType,u8 scanKind,str value,str value2,str pkgFilter,u32 maxVisited,u32 maxMatches,u32 limit,u8 userClassesOnly,u8 useDropbox,u8 rootsOnly; resp: page
    ...
    public static final int MSG_LIST_INSTANCES = 0x37;     // req: str class,u32 maxInstances,u32 maxVisited,u8 fromDropbox; resp: u32 count,[u64 id,str label]*
